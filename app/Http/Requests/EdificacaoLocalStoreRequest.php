...
class EdificacaoLocalStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'name' => [
                'required',
                Rule::unique('edificacoes_locais')->where(function ($query) {
                    return $query->where('edificacao_nivel_id', $this->edificacao_nivel_id);
                }),
            ],
        ];
    }
