...
class EdificacaoStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'quantidade_lucs' => ['required', 'integer', 'min:0'],
            'grupo' => ['required'],
            'divisao' => ['required'],
    ...
    public function messages()
    {
        $messages = [
            ...
            'quantidade_lucs.required' => 'LUCs é requerido.',
            'quantidade_lucs.integer' => 'LUCs tem que ser um número inteiro.',
            'quantidade_lucs.min' => 'LUCs tem que ser no mínimo 0(zero).',
