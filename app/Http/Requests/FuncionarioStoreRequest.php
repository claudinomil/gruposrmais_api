...
class FuncionarioStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'carteira_nacional_estado_id' => ['nullable', 'integer', 'numeric'],
            'carteira_nacional_numero' => ['nullable', 'numeric'],
            'carteira_nacional_data_emissao' => ['nullable', 'date_format:d/m/Y'],
            'carteira_nacional_orgao_id' => ['nullable', 'integer', 'numeric'],
    ...
    public function messages()
    {
        return [
            ...
            'carteira_nacional_orgao_id.integer' => 'A Carteira Nacional (Òrgão) deve ser um ítem da lista.',
            'carteira_nacional_estado_id.integer' => 'A Carteira Nacional (Estado) deve ser um ítem da lista.',
            'carteira_nacional_numero.numeric' => 'A Carteira Nacional (Número) deve ser um número válido.',
            'carteira_nacional_data_emissao.date_format' => 'A Carteira Nacional (Emissão) não é uma data válida.',
