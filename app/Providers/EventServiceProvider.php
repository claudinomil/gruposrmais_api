...
use App\Observers\MapaPreventivoObserver;
use App\Observers\EdificacaoLocalObserver;
use App\Observers\EdificacaoObserver;
use App\Observers\EquipamentoPreventivoObserver;
...
use App\Observers\ProdutoEntradaObserver;
use App\Observers\ProdutoMovimentacaoObserver;
use App\Observers\ProdutoObserver;
use App\Observers\OrdemServicoObserver;
use App\Observers\PropostaObserver;
use App\Observers\MedidaSegurancaObserver;
use App\Observers\SistemaPreventivoObserver;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        EquipamentoPreventivo::observe(EquipamentoPreventivoObserver::class);
        ...
        ProdutoEntrada::observe(ProdutoEntradaObserver::class);
        ProdutoMovimentacao::observe(ProdutoMovimentacaoObserver::class);
