...
//            ["nome" => "ADRIANO DE SOUZA BRANDÃO", "genero_id" => 2, "data_nascimento" => "02/07/1984", "cpf" => "10865790701", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "2122484005", "pix_tipo_id" => "1", "pix_chave" => "21971170978", "departamento_id" => "6", "funcao_id" => "10"],
            ...
            ["nome" => "MARCUS VINICIUS BARBOSA DA FONSECA", "genero_id" => 2, "data_nascimento" => "06/07/1996", "cpf" => "16974024703", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "297914244", "pix_tipo_id" => "1", "pix_chave" => "21968549135", "departamento_id" => "6", "funcao_id" => "10"],
            ["nome" => "BRENO BARREIROS DA SILVA", "genero_id" => 2, "data_nascimento" => "07/04/1989", "cpf" => "01563425297", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "6756057", "pix_tipo_id" => "2", "pix_chave" => "01563425297", "departamento_id" => "6", "funcao_id" => "10"],
            ["nome" => "SANDRO ROGERIO DE SOUZA NASCIMENTO", "genero_id" => 2, "data_nascimento" => "15/12/1973", "cpf" => "03594341771", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "101610491", "pix_tipo_id" => "1", "pix_chave" => "21979673243", "departamento_id" => "6", "funcao_id" => "10"],
            ...
            ["nome" => "JEAN DE SOUZA RODRIGUES", "genero_id" => 2, "data_nascimento" => "04/12/2004", "cpf" => "17751266767", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "338963069", "pix_tipo_id" => "2", "pix_chave" => "17751266767", "departamento_id" => "6", "funcao_id" => "10"],
            ["nome" => "BRUNO DA SILVA DUARTE", "genero_id" => 2, "data_nascimento" => "14/04/1989", "cpf" => "12871383731", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "211486808", "pix_tipo_id" => "1", "pix_chave" => "21983285777", "departamento_id" => "6", "funcao_id" => "10"],
//            ["nome" => "ALAN RAMOS MENDES", "genero_id" => 2, "data_nascimento" => "05/08/1997", "cpf" => "18511892702", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "281482018", "pix_tipo_id" => NULL, "pix_chave" => "", "departamento_id" => "6", "funcao_id" => "10"],
            ...
            ["nome" => "MARCELO EDUARDO SANFROT JUNGER", "genero_id" => 2, "data_nascimento" => "27/11/1998", "cpf" => "18415722761", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "29890344", "pix_tipo_id" => "1", "pix_chave" => "21990666748", "departamento_id" => "6", "funcao_id" => "10"],
//            ["nome" => "CHARLES ALPHONSE SERPA", "genero_id" => 2, "data_nascimento" => "17/08/1979", "cpf" => "05321403708", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "0119601847", "pix_tipo_id" => "4", "pix_chave" => "charlesserpa06@gmail.com", "departamento_id" => "6", "funcao_id" => "10"],
            ["nome" => "JONATHA DOS SANTOS LUZ AGUIAR", "genero_id" => 2, "data_nascimento" => "06/11/1993", "cpf" => "15246464741", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "272263526", "pix_tipo_id" => "4", "pix_chave" => "jonatha93@gmail.com", "departamento_id" => "6", "funcao_id" => "10"],
//            ["nome" => "SUZANE BORGES", "genero_id" => 2, "data_nascimento" => "08/06/1989", "cpf" => "13317554762", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "267467694", "pix_tipo_id" => NULL, "pix_chave" => "", "departamento_id" => "6", "funcao_id" => "10"],
//            ["nome" => "LETICIA FREITAS BORELI", "genero_id" => 2, "data_nascimento" => "21/04/1997", "cpf" => "17931036743", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "308381201", "pix_tipo_id" => "2", "pix_chave" => "17931036743", "departamento_id" => "6", "funcao_id" => "10"],
//            ["nome" => "BETRIZ KAROLINE DA SILVA", "genero_id" => 2, "data_nascimento" => "08/03/1993", "cpf" => "14335931735", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "211332309", "pix_tipo_id" => "2", "pix_chave" => "14335931735", "departamento_id" => "6", "funcao_id" => "10"],
            ["nome" => "PAULO ROBERTO DOS SANTOS MARTINS JUNIOR", "genero_id" => 2, "data_nascimento" => "18/09/1997", "cpf" => "18368855713", "personal_identidade_estado_id" => "19", "personal_identidade_orgao_id" => "70", "personal_identidade_numero" => "", "pix_tipo_id" => "1", "pix_chave" => "21989351544", "departamento_id" => "6", "funcao_id" => "10"],
