...
Route::prefix('clientes')->group(function () {
    ...
    Route::post('/editarDocumento/editar_documento', [ClienteController::class, 'editar_documento'])->middleware(['auth:api']);
    ...
    Route::post('/editarLoja/editar_loja', [ClienteController::class, 'editar_loja'])->middleware(['auth:api']);
    Route::get('/modalInfo/lojas/{cliente_id}', [ClienteController::class, 'lojas'])->middleware(['auth:api']);
    Route::delete('/modalInfo/deletar_loja/destroy/{id}', [ClienteController::class, 'deletar_loja'])->middleware(['auth:api']);
    Route::post('/editarSistemaPreventivo/editar_sistema_preventivo', [ClienteController::class, 'editar_sistema_preventivo'])->middleware(['auth:api']);
    Route::get('/modalInfo/sistemas_preventivos/{cliente_id}', [ClienteController::class, 'sistemas_preventivos'])->middleware(['auth:api']);
    Route::delete('/modalInfo/deletar_sistema_preventivo/destroy/{id}', [ClienteController::class, 'deletar_sistema_preventivo'])->middleware(['auth:api']);
