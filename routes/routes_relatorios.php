...
Route::prefix('relatorios')->group(function () {
    ...
    Route::get('/relatorio10/{material_id}/{material_categoria_id}/{estoque_local_id}/{empresa_id}/{cliente_id}/{material_situacao_id}/{idioma}', [RelatorioController::class, 'relatorio10'])->middleware(['auth:api']);
});
