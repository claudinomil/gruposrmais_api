...
Route::prefix('clientes_executivos')->group(function () {
    Route::get('/index', [ClienteExecutivoController::class, 'index'])->middleware(['auth:api']);
    Route::get('/show/{id}', [ClienteExecutivoController::class, 'show'])->middleware(['auth:api']);
    Route::get('/filter/{array_dados}', [ClienteExecutivoController::class, 'filter'])->middleware(['auth:api']);
    Route::post('/store', [ClienteExecutivoController::class, 'store'])->middleware(['auth:api']);
    Route::put('/update/{id}', [ClienteExecutivoController::class, 'update'])->middleware(['auth:api']);
    Route::delete('/destroy/{id}', [ClienteExecutivoController::class, 'destroy'])->middleware(['auth:api']);
    ...
    Route::get('/cartoes_emergenciais/dados/{ids}', [ClienteExecutivoController::class, 'cartoes_emergenciais_dados'])->middleware(['auth:api']);
});