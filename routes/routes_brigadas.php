...
Route::prefix('brigadas')->group(function () {
    Route::get('/index/{empresa_id}', [BrigadaController::class, 'index'])->middleware(['auth:api']);
    Route::get('/show/{id}', [BrigadaController::class, 'show'])->middleware(['auth:api']);
    Route::get('/filter/{array_dados}/{empresa_id}', [BrigadaController::class, 'filter'])->middleware(['auth:api']);
    Route::put('/update/{id}/{empresa_id}', [BrigadaController::class, 'update'])->middleware(['auth:api']);
